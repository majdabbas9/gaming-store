...
public partial class EditProdoctBy2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if ((Request.QueryString["TypeID"] == null) && (Request.QueryString["ProductName"] == null))
        {
    ...
    public void FillGrid()
    {
        ...
        {
            GridViewP.DataSource = ClassProduct.GetALLbyType(Request.QueryString["TypeID"].ToString());
            GridViewP.DataBind();
        }
        else
        {
            GridViewP.DataSource = ClassProduct.GetByProductName(Request.QueryString["ProductName"].ToString());
            GridViewP.DataBind();
